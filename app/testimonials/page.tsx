...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.smartbrainsindia.in/testimonials',
    siteName: 'Smart Brains India',
    images: [{ url: 'https://www.smartbrainsindia.in/og-testimonials.jpg', width: 1200, height: 630, alt: 'Parent Testimonials' }],
    locale: 'en_IN',
    type: 'website'
  },
  alternates: { canonical: 'https://www.smartbrainsindia.in/testimonials' },
  twitter: {
    card: 'summary_large_image',
    title: 'Parent Testimonials | Brain Training & Memory Classes Results',
    description: 'Read real testimonials from parents who have seen improvements in their children’s memory, focus, maths performance and confidence.',
    images: ['https://www.smartbrainsindia.in/og-testimonials.jpg']
  },
