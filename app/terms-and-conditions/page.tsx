      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">2. Services</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">3. Enrollment and Registration</h2>
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">4. Fees and Payment</h2>
              <div className="text-gray-600 leading-relaxed space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">5. Refund Policy</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">6. Student Conduct</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">9. Cancellation and Rescheduling</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">11. Modifications to Terms</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">12. Governing Law</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">13. Contact Information</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
