      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">4. Data Protection</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">5. Sharing Your Information</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-gray-900 mb-4">7. Cookies</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
